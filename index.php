                    ...
                    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="">
                                    <a href="index.php?p=loja_ingresso">
                                        <span class="pcoded-micon"><i class="ti-bag"></i><b>D</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">Loja </span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="index.php?p=meus_ingressos">
                                        <span class="pcoded-micon"><i class="ti-control-play"></i><b>D</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">Meus Ingressos</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="">
                                    <a href="index.php?p=gerenciar_ingresso">
                                        <span class="pcoded-micon"><i class="ti-bag"></i><b>D</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">Gerenciar Ingressos</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li class="">
