...
$sql_query = $mysqli->query("SELECT * FROM ingressos WHERE id = '$id'") or die($mysqli->error);
$ingressos = $sql_query->fetch_assoc();
        ...
        <div class="col-lg-6">
            <div class="page-header-breadcrumb">
                <ul class="breadcrumb-title">
                    ...
                    <li class="breadcrumb-item">
                        <a href="index.php?p=gerenciar_ingresso">
                            Gerenciar Ingressos
                        </a>
                    </li>
                    <li class="breadcrumb-item">Cadastrar Ingressos</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo $ingressos['titulo']; ?>" name="titulo" class="form-control">
                                </div>  
                            </div>
                            <div class="col-lg-8">
                                <div class="form-group">
                                    <label for="">Descrição Curta</label>
                                    <input type="text" value="<?php echo $ingressos['descricao_curta']; ?>" name="descricao_curta" class="form-control">
                                </div>  
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo $ingressos['preco']; ?>" name="preco" class="form-control">
                                </div>  
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="">Conteúdo</label>
                                    <textarea name="conteudo" rows="10" class="form-control"><?php echo $ingressos['conteudo']; ?></textarea>
                                </div>  
                            </div>
                            <div class="col-lg-12">
                                <a href="index.php?p=gerenciar_ingresso" class="btn btn-primary btn-round"><i class="ti-arrow-left"></i> Voltar</a>
